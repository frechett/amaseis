...
//  FILE:         stationsaboutdlg.cpp
//  AUTHOR:       Alan Jones
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TStationsAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TStationsAboutDlg Implementation}}
...
//
TStationsAboutDlg::TStationsAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TStationsAboutDlg::~TStationsAboutDlg()
{
  Destroy();
...
void TStationsAboutDlg::SetupWindow()
{
